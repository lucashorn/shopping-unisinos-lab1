public class Principal {
    ...
    private static Loja criarLoja(){
        ...
        int qtdProdutos = Teclado.leInt("Digite a quantidade de produtos que a loja terá: ");
        ...
        if (salarioBaseFuncionario == 0.0) {
             novaLoja = new Loja(nome, quantidadeFuncionarios, endereco, data, qtdProdutos);
        } else {
             novaLoja = new Loja(nome, quantidadeFuncionarios, salarioBaseFuncionario, endereco, data, qtdProdutos);
        }
